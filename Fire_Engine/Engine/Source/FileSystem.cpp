...
//using namespace std;
//
//FileSystem::FileSystem(const char* game_path) : Module("File System", true)
//{
...
//		ret = true;
//
//		LOG(LogType::L_NORMAL, "File System copied file [%s] to [%s]", full_path, destination);
//	}
//	else
//		LOG(LogType::L_ERROR, "File System error while copy from [%s] to [%s]", full_path, destination);
//
//	return ret;
//}
//
...
//		ret = true;
//
//		LOG(LogType::L_NORMAL, "File System copied file [%s] to [%s]", source, destination);
//	}
//	else
//		LOG(LogType::L_ERROR, "File System error while copy from [%s] to [%s]", source, destination);
//
//	return ret;
//}
//
...
//		}
//		else
//			LOG(LogType::L_ERROR, "File System error while trying to delete [%s]: ", file, PHYSFS_getLastError());
//	}
//
//	return ret;
//}
...
//		LOG(LogType::L_ERROR, "File System error while CLOSE via bass: %s", PHYSFS_getLastError());
//}
//
...
//	if(ret == -1)
//		LOG(LogType::L_ERROR, "File System error while SIZE via bass: %s", PHYSFS_getLastError());
//
//	return (QWORD) ret;
//}
//
...
//	if(ret == -1)
//		LOG(LogType::L_ERROR, "File System error while READ via bass: %s", PHYSFS_getLastError());
//
//	return (DWORD) ret;
//}
//
...
//	if(res == 0)
//		LOG(LogType::L_ERROR, "File System error while SEEK via bass: %s", PHYSFS_getLastError());
//
//	return (BOOL) res;
//}
//
